...
import { VStack, Input, Button, Box, useToast, Textarea, Heading, Text, HStack, AlertDialog, AlertDialogBody, AlertDialogFooter, AlertDialogHeader, AlertDialogContent, AlertDialogOverlay } from "@chakra-ui/react";
...
const AddCategoryForm = () => {
    ...
    return (
        <HStack spacing={4} w="90%" justifySelf="center" flex={1}>
            <VStack w="80%"><Input
            ...
            <VStack spacing={4} w="100%" mt={4} h="400px" overflowY="auto" p={5}>
