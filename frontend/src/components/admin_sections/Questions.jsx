...
const Questions = () => {
    ...
    const handleAddOption = () => {
        setEditedOptions([...editedOptions, { optionText: "", score: 0 }]);
    };
    ...
    return (
        <>
            <Tabs
                ...
                p={5}
            >
                <TabList py={2} px={5} bg="white" rounded="full" boxShadow="sm">
                    ...
                    {
                        categories.length === 0 && <Tab>No categories found</Tab>
                    }
                </TabList>
                <TabPanels>
                    {categories.map((category) => (
                    ...
                    <ModalBody>
                        ...
                        {editedOptions.map((option, index) => (
                            <FormControl key={index} mt={4}>
                                <HStack align="center">
                                    <FormLabel h="fit-content">Option {index + 1}</FormLabel>
                                    <IconButton
